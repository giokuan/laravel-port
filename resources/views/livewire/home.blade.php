...
<section class="bg-white dark:bg-gray-900">
    <div class="flex flex-col max-w-screen-xl px-4 pt-20 pb-8 mx-auto xl:flex-row lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
           ...
           <div class="mx-auto">
                <div class="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[16px] rounded-t-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px]">
                    <div class="rounded-xl overflow-hidden h-[140px] md:h-[262px]">
                        <img src="storage/programming.gif" class="dark:hidden h-[140px] md:h-[262px] w-full rounded-xl" alt="">
        ...
        <div class="mr-auto place-self-center lg:col-span-7 xl:order-1">
            ...
            Welcome to my digital playground, where lines of code transform into sleek solutions!<br><br> I'm <span class="text-blue-500 animate-pulse">Giovanni Kuan, </span>
            a passionate freelance software developer with a knack for crafting intuitive experiences and robust 
            applications. From concept to execution, I thrive on turning ideas into reality, one keystroke at a time. 
