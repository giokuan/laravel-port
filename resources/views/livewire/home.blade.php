...
<div class="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[16px] rounded-t-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[912px]">
    <div class="rounded-xl overflow-hidden h-[140px] md:h-[262px]">
        ...
        <!-- <img src="{{asset('storage/eatcode.gif')}}" class="dark:hidden h-[140px] md:h-[262px] w-full rounded-xl" alt="computer"> -->
