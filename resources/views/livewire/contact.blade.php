            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex items-center justify-center w-10 h-10 bg-gray-500 rounded text-gray-50 animate-pulse">
                            ...
                            <div class="mb-8 ml-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">312 Tipas San Juan Batangas Philippines</p>
                    ...
                    <form id="contactForm" wire:submit.prevent="submitForm">
                        ...
                        <div class="mb-6">
                            <div class="mx-0 mb-1 sm:mb-4">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <label for="name" class="pb-1 text-xs tracking-wider uppercase"></label><input wire:model="name" type="text" id="name" autocomplete="given-name" placeholder="Your name" class="w-full py-2 pl-2 pr-4 mb-2 border border-gray-400 rounded-md shadow-md dark:text-gray-300 sm:mb-0" name="name">
                                     @error('name') <em class="text-red-500">{{ $message }}</em> @enderror
                                </div>
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <label for="email" class="pb-1 text-xs tracking-wider uppercase"></label><input wire:model="email" type="email" id="email" autocomplete="email" placeholder="Your email address" class="w-full py-2 pl-2 pr-4 mb-2 border border-gray-400 rounded-md shadow-md dark:text-gray-300 sm:mb-0" name="email">
                                     @error('email') <em class="text-red-500">{{ $message }}</em> @enderror
                                </div>
                            </div>
                            <div class="mx-0 mb-1 sm:mb-4">
                                <label for="textarea" class="pb-1 text-xs tracking-wider uppercase"></label><textarea wire:model="message" id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..." class="w-full py-2 pl-2 pr-4 mb-2 border border-gray-400 rounded-md shadow-md dark:text-gray-300 sm:mb-0"></textarea>
                                 @error('message') <em class="text-red-500">{{ $message }}</em> @enderror
                            </div>
                        </div>
