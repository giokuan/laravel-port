<div>
    <div class="max-w-3xl px-5 mx-auto mt-28">
        <div class="flex flex-col justify-center">
            ...
            <div class="mb-4 text-center">
                ...
                <h2 class="text-3xl font-semibold text-gray-500">My Stacks</h2>

                <p class="flex items-start mx-auto mt-2 text-gray-500 text-start">

                    TALL stacks, an acronym for "Tailwind CSS, Alpine.js, Laravel, and Livewire," represent a powerful
                    and
                    modern web development ecosystem. This stack leverages the strengths of each technology to create
                    robust, dynamic, and efficient web applications.<br><br>

                    Together, the TALL stack offers a cohesive and efficient development experience, empowering
                    developers
                    to build modern web applications with speed, flexibility, and maintainability. Whether you're
                    creating a
                    simple website or a complex web application, TALL stacks provide the tools and capabilities needed
                    to
            ...
            <div class="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
                ...
                <div class="flex flex-col items-center justify-center px-4 text-gray-400 rounded-lg shadow ">
                ...
                <div
                    class="flex flex-col items-center justify-center px-4 text-gray-400 rounded-lg shadow moving-border ">
                    <svg width="82" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
    ...
    <div data-aos="zoom-out" data-aos-duration="2000" class="max-w-3xl px-5 mx-auto mt-28">
        <div class="flex flex-col justify-center">

            <div class="text-center">

                <h2 class="mb-4 text-3xl font-semibold text-gray-500">Other Tech I used</h2>
            ...
            <div class="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
                ...
                <div class="flex flex-col items-center justify-center text-gray-400 rounded-lg shadow "><svg
                        width="82" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                ...
                <div class="flex flex-col items-center justify-center text-gray-400 rounded-lg shadow">
                    <svg width="82" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                        <path
                ...
                <div class="flex flex-col items-center justify-center text-gray-400 rounded-lg shadow"><svg width="82" height="50" viewBox="-18.458 -22.75 191.151 191.151" xmlns="http://www.w3.org/2000/svg" fill="#000000">
