...
<div class="relative w-full">
        ...
        <main class="container mx-auto mt-8">
            <div class="flex flex-wrap justify-between">
                <div class="w-full px-4 mb-8 md:w-8/12">
                    <img src="{{asset('storage/gev.png')}}" alt="Featured Image" class="object-cover w-full h-3/4 rounded">
                    <h2 class="mt-4 mb-2 text-lg font-semibold text-gray-500 md:text-2xl lg:text-4xl">GEV Website</h2>
                    <p class="mb-4 text-sm text-gray-700 md:text-base">GEV Construction Finishing Services – 
                        A construction company specializing in high-quality finishing services, including painting, 
                        flooring, drywall, carpentry, and tiling for residential, commercial, and industrial projects.

                        Built and designed their official website to showcase their services, projects, and company expertise.</p>
    ...
    <div class="sticky top-0 flex flex-col items-center justify-center h-screen bg-gray-50">
        <main class="container mx-auto mt-8">
            <div class="flex flex-wrap justify-between">
                <div class="w-full px-4 mb-8 md:w-8/12">
                    <img src="{{asset('storage/tgp.png')}}" alt="Featured Image" class="object-cover w-full h-3/4 rounded">
    ...
    <div class="sticky top-0 flex flex-col items-center justify-center h-screen text-white bg-gray-50">
        <main class="container mx-auto mt-8">
            <div class="flex flex-wrap justify-between">
                <div class="w-full px-4 mb-8 md:w-8/12">
                    <img src="{{asset ('storage/tinhs.png')}}" alt="Featured Image" class="object-cover w-full h-3/4 rounded">
    ...
    <div class="sticky top-0 flex flex-col items-center justify-center h-screen text-white bg-white">
        <main class="container mx-auto mt-8">
            <div class="flex flex-wrap justify-between">
                <div class="w-full px-4 mb-8 md:w-8/12">
                    <img src="{{asset('storage/barangay.png')}}" alt="Featured Image" class="object-cover w-full h-3/4 rounded">
    ...
    <div class="sticky top-0 flex flex-col items-center justify-center h-screen text-black bg-gray-50">
        <main class="container mx-auto mt-8">
            <div class="flex flex-wrap justify-between">
                <div class="w-full px-4 mb-8 md:w-8/12">
                    <img src="{{asset('storage/lazy-reader.png')}}" alt="Featured Image" class="object-cover w-full h-64 rounded">
