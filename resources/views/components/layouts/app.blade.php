                ...
                <div {{ $attributes->class(['hidden-when-collapsed']) }}>
                    <div class="flex flex-col items-center gap-2 my-8 ">
                        ...
                        <nav class="flex gap-4 mr-4 text-gray-500 dark:text-sky-500">
                            ...
                            <a href="https://www.linkedin.com/in/gio-kuan/"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="https://www.facebook.com/giokuan"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" viewBox="0 0 24 24" class="fill-current">
                                    <path
