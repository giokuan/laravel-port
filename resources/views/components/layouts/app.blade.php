...
<body >
    ...
    <x-nav sticky class="lg:hidden">
        <x-slot:brand>
            <x-app-brand />
            <img src="{{ asset('storage/profile.png') }}" class="w-10 border rounded-full "/>
    ...
    <x-main full-width >
        {{-- SIDEBAR --}}
        <x-slot:sidebar drawer="main-drawer" collapsible class="z-50 shadow-md bg-base-100 dark:bg-gray-900 lg:bg-gray-100">
                 ...
                 <div {{ $attributes->class(["hidden-when-collapsed"]) }}>
                    ...
                    <div class="relative mx-auto bg-gray-800 dark:bg-gray-700 rounded-b-[2.5rem] h-[63px] max-w-[133px]"></div>
                            ...
                            <span class="mr-3 text-3xl font-semibold text-gray-500 dark:text-sky-500">
                                Giovanni Kuan
                                 <span class="flex items-center justify-center text-sm font-semibold text-gray-500 dark:text-sky-500">
                               Software Developer
                            </span>
                            </span>
                                ...
                                <nav class="flex gap-4 mr-4 text-gray-500 dark:text-sky-500">
                                    ...
                                    <a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                                    ...
                                    <a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" class="fill-current">
